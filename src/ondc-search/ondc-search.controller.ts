...
export class OndcSearchController {
  ...
  @ApiOperation({
    ...
    description: 'Test endpoint to perform specific ONDC search with custom parameters',
  })
  @ApiBody({
    ...
    schema: {
      type: 'object',
      properties: {
        city: { type: 'string', example: 'std:0452', description: 'City code for search' },
        search_term: { type: 'string', example: 'pizza', description: 'Search term' },
        category_id: { type: 'string', example: 'F&B', description: 'Category ID' },
        gps: { type: 'string', example: '12.9716,77.5946', description: 'GPS coordinates' },
        area_code: { type: 'string', example: '560001', description: 'Area code' }
      }
    }
  })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description: 'Webhook endpoint to receive catalog data from ONDC network. Processes catalog data and returns ACK/NACK response.',
  })
  @ApiBody({
        ...
        value: {
          ...
          "message": {
            "catalog": {
              "bpp/descriptor": {
                "name": "Squadcube",
                "short_desc": "Squadcube is a seller platform that enables multiple sellers to list and sell their products on the ONDC network.",
                "long_desc": "Squadcube is a comprehensive seller platform designed to empower businesses to seamlessly list and sell their products on the ONDC network.",
                "symbol": "https://ondcstg.squadcube.in/app/image/sq-logo.svg",
                "images": [
                  "https://ondcstg.squadcube.in/app/image/sq-logo.svg"
                ],
                "tags": [
                  {
                    "code": "bpp_terms",
              ...
              "bpp/providers": [
                {
                  ...
                  "descriptor": {
                    ...
                    "short_desc": "Hotel Temple city is a f&b store offering products through the ONDC platform online.",
                    "long_desc": "Hotel Temple city is a f&b store that offers a wide range of products online through the ONDC platform.",
                    "symbol": "https://in-maa-1.linodeobjects.com/sqc-bucket/staging/stores/965/logo/1761301387125-6e7e80cb-270e-40cc-a34a-5d24025d5ac8.jpg",
                    "images": [
                  ...
                  "items": [
                    {
                      ...
                      "descriptor": {
                        ...
                        "symbol": "https://in-maa-1.linodeobjects.com/sqc-bucket/staging/stores/965/products/22756/thumbnail_image/1761301895849-873e5709-491a-461b-a570-fa9f4aaefcc9.jpeg",
                        "images": [
                      ...
                      "@ondc/org/contact_details_consumer_care": "Support Team,templecity@yopmail.com,9894683335",
                      "tax": {
                        "percent": 5
                      },
          ...
          properties: {
            ack: {
              ...
              properties: {
                ...
                message_id: { type: 'string', example: 'f6ea6c85-4338-4503-a0d1-5a888bb916f4' },
                message: { type: 'string', example: 'Catalog Data not processed - missing required fields' }
              }
            }
          }
        }
            ...
            ack: {
              ...
              properties: {
                ...
                error: {
                  type: 'object',
                  properties: {
                    code: { type: 'string', example: 'CATALOG_PROCESSING_FAILED' },
  ...
  async receiveOndcCatalog(@Body() catalogData: ONDCOnSearchResponseDto) {
    try {
      ...
      if (catalogData?.context && 
        ...
        this.logger.warn(`Invalid catalog data received. Missing required fields.`);
        return {
          message: {
            ack: {
              status: "NACK",
