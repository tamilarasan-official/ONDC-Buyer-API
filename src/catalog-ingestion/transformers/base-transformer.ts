...
export abstract class BaseTransformer {
  ...
  protected parseBoolean(
    ...
    return (
      stringValue === "true" || stringValue === "yes" || stringValue === "1"
    );
  }
