...
export class AddParentItemId1700000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "item" ADD CONSTRAINT "FK_item_parent_item_id" FOREIGN KEY ("parent_item_id") REFERENCES "item"("id") ON DELETE CASCADE`);
        
        // Add index for better performance
        await queryRunner.query(`CREATE INDEX "IDX_item_parent_item_id" ON "item" ("parent_item_id")`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "item" DROP CONSTRAINT "FK_item_parent_item_id"`);
