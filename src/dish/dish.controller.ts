...
export class DishController {
  ...
  @ApiOperation({
    ...
    description:
      "Create a new dish with name, description, food_type, icon file, and status. Icon file must be jpg, png, or webp format. File will be uploaded to S3 with naming pattern: dishes/{dish-name-without-spaces}.{extension}",
  })
    ...
    schema: {
      ...
      properties: {
        ...
        status: {
          type: "string",
          example: "true",
          description: 'Status as string: "true" or "false"',
        },
        icon: {
          type: "string",
          format: "binary",
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Invalid file format. Only jpg, png, webp allowed",
        },
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Dish with this name already exists",
        },
  ...
  @ApiResponse({
    status: 500,
    description:
      "Internal server error - File upload or database operation failed",
    schema: {
      type: "object",
      properties: {
        success: { type: "boolean", example: false },
        message: {
          type: "string",
          example: "Failed to upload file or save dish",
        },
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve dishes with optional filtering and sorting. If no pagination parameters (page/limit) are provided, returns all dishes in a single response. Default ordering is by sequence (drag & drop order) in ASC order.",
  })
  @ApiQuery({
    name: "page",
    description:
      "Page number for pagination (optional - if not provided, returns all dishes)",
    example: 1,
    required: false,
    type: "number",
  })
  @ApiQuery({
    name: "limit",
    description:
      "Number of items per page (optional - if not provided, returns all dishes)",
    example: 10,
    required: false,
    type: "number",
  })
  ...
  @ApiQuery({
    name: "order_by",
    description:
      "Order dishes by field (sequence, name, created_at). Note: sequence is always ordered ASC regardless of sortOrder parameter.",
    example: "sequence",
    required: false,
    type: "string",
  })
  ...
  @ApiOperation({
    summary: "Update dish",
    description:
      "Update an existing dish's information including name, description, food_type, icon file, and status. Icon file must be jpg, png, or webp format. File upload is optional for updates. If provided, old file will be deleted and new file uploaded with naming pattern: dishes/{dish-name-without-spaces}.{extension}",
  })
  @ApiConsumes("multipart/form-data")
  @ApiParam({
    name: "id",
    ...
    schema: {
      ...
      properties: {
        ...
        icon: {
          ...
          format: "binary",
          description:
            "Icon image file (jpg, png, webp only) - optional for updates",
        },
      },
    },
  })
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Failed to upload file or update dish",
        },
        error: { type: "string", example: "INTERNAL_SERVER_ERROR" },
      },
    },
  ...
  @ApiOperation({
    summary: "Delete dish",
    description:
      "Delete a dish by its ID. This action cannot be undone. The associated icon file will also be deleted from S3 storage.",
  })
  @ApiParam({
    name: "id",
  ...
  @ApiResponse({
    status: 500,
    description:
      "Internal server error - File deletion or database operation failed",
    schema: {
      type: "object",
      properties: {
        success: { type: "boolean", example: false },
        message: {
          type: "string",
          example: "Failed to delete dish or associated file",
        },
        error: { type: "string", example: "INTERNAL_SERVER_ERROR" },
      },
    },
  ...
  @ApiOperation({
    ...
    description:
      "Reorder multiple dishes by providing their new sequence positions. Useful for drag and drop functionality.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Move a single dish to a specific position within its food type. Other dishes will be automatically reordered.",
  })
  @ApiParam({
    name: "id",
  ...
  @ApiOperation({
    ...
    description:
      "Remove gaps in sequence numbers and renumber dishes in order. Useful for cleanup after deletions.",
  })
  @ApiQuery({
    name: "food_type",
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Sequences normalized successfully",
        },
      },
    },
  })
