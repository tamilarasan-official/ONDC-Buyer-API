...
export class AddTaxFieldsToStoreAndItem1756718914550
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "item" ADD "tax_type" character varying(20)`,
    );
    await queryRunner.query(
      `ALTER TABLE "item" ADD "hsn_code" character varying(20)`,
    );
    await queryRunner.query(
      `ALTER TABLE "store" ADD "gst_number" character varying(15)`,
    );
  }
