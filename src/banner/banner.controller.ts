...
export class BannerController {
  ...
  @ApiOperation({
    ...
    description:
      "Create a new promotional banner with title, subtitle, CTA button, image file, and other settings. Image file must be jpg, png, or webp format. File will be uploaded to S3 with naming pattern: banners/{title-without-spaces}.{extension}",
  })
    ...
    schema: {
      ...
      properties: {
        ...
        promotion_link: {
          ...
          example: "1",
          description:
            "The actual link value: restaurant ID, category ID, or full URL depending on promotion_type",
        },
        status: {
          type: "string",
          example: "true",
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        image_url: {
          type: "string",
          example: "https://bucket.com/banners/CravingSomethingDelicious.jpg",
        },
        background_color: { type: "string", example: "#14b8a6" },
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve banners with optional filtering and sorting. If no pagination parameters (page/limit) are provided, returns all banners in a single response. Default ordering is by sequence (drag & drop order) in ASC order.",
  })
  @ApiQuery({
    name: "page",
    description:
      "Page number for pagination (optional - if not provided, returns all banners)",
    example: 1,
    required: false,
    type: "number",
  })
  @ApiQuery({
    name: "limit",
    description:
      "Number of items per page (optional - if not provided, returns all banners)",
    example: 10,
    required: false,
    type: "number",
  })
  ...
  @ApiQuery({
    name: "order_by",
    description:
      "Order banners by field (sequence, title, created_at). Note: sequence is always ordered ASC regardless of sortOrder parameter.",
    example: "sequence",
    required: false,
    type: "string",
  })
          ...
          items: {
            ...
            properties: {
              ...
              image_url: {
                type: "string",
                example:
                  "https://bucket.com/banners/CravingSomethingDelicious.jpg",
              },
              background_color: { type: "string", example: "#14b8a6" },
              promotion_type: { type: "string", example: "restaurant_id" },
              promotion_link: { type: "string", example: "1" },
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all active banners ordered by sequence. Used by the home API.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Update banner details. Image file is optional - if provided, old image will be deleted and new one uploaded.",
  })
  @ApiConsumes("multipart/form-data")
  @ApiParam({
    name: "id",
  ...
  @ApiOperation({
    ...
    description:
      "Delete a banner by ID. This will also delete the associated image from S3.",
  })
  @ApiParam({
    name: "id",
    description: "Banner ID",
  ...
  @ApiOperation({
    ...
    description:
      "Update sequence positions for multiple banners. All banners in the array will be updated with new sequence numbers.",
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      "Move a single banner to a new sequence position. Other banners will be automatically reordered.",
  })
  @ApiParam({
    name: "id",
    description: "Banner ID",
  ...
  @ApiOperation({
    ...
    description:
      "Renumber all banner sequences sequentially starting from 1 to eliminate gaps.",
  })
  @ApiResponse({
    status: 200,
