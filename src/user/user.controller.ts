...
export class UserController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific address by its ID. This endpoint is public and can be used to get address details.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description: 'Delete a specific address by its ID. This endpoint is public and can be used to remove addresses.',
  })
  @ApiParam({
    name: 'id',
