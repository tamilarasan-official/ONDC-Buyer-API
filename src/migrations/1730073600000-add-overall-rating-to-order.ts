...
export class AddOverallRatingToOrder1730073600000 implements MigrationInterface {
    name = 'AddOverallRatingToOrder1730073600000'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Add overall_rating column to order table
        await queryRunner.query(`ALTER TABLE "order" ADD "overall_rating" numeric(3,2)`);
    }
