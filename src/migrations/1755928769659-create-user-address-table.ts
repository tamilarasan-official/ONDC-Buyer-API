...
export class CreateUserAddressTable1755928769659 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_d864090ed6e27b03db1eee6eaff"`);
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "REL_d864090ed6e27b03db1eee6eaf"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "user_otp_id"`);
        await queryRunner.query(`ALTER TABLE "user_otp" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user_otp" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "UQ_494c022ed33e6ee19a2bbb11b22" UNIQUE ("otp_id")`);
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_494c022ed33e6ee19a2bbb11b22" FOREIGN KEY ("otp_id") REFERENCES "user_otp"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_494c022ed33e6ee19a2bbb11b22"`);
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "UQ_494c022ed33e6ee19a2bbb11b22"`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "REL_d864090ed6e27b03db1eee6eaf" UNIQUE ("user_otp_id")`);
        await queryRunner.query(`ALTER TABLE "user" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user_otp" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user_otp" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`DROP TABLE "user_address"`);
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_d864090ed6e27b03db1eee6eaff" FOREIGN KEY ("user_otp_id") REFERENCES "user_otp"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
