...
export class InvoiceController {
  ...
  @ApiOperation({
    ...
    description:
      "Get structured invoice data in JSON format. Works directly for delivered orders - no separate generation step needed.",
  })
  @ApiParam({
    name: "orderId",
    description: "Order ID",
  ...
  @ApiOperation({
    ...
    description:
      "Download PDF invoice for a specific order. Works directly for delivered orders - no separate generation step needed.",
  })
  @ApiParam({
    name: "orderId",
    description: "Order ID",
